...
class Navbar {
	...
	_navBecomeSmall = () => {
		...
		tween.to("nav", { duration: 0.6, ease: "pow2", opacity: 0, x: 300, display: "none"})
	...
	_navBecomeBig = () => {
		...
		tween.to("nav", { duration: 0.6, ease: "pow2", opacity: 1, x: 0, display: "flex"})
		gsap.to(".menu", {duration: 1, ease: "pow2", opacity: 0, display: "none"})
	}
}
